...
var checkRequiredFields = function checkRequiredFields(inputdata) {
  var arr = ['doctorId', 'contentHTML', 'contentMarkDown', 'actions', 'selectedPrice', 'selectedPayment', 'selectedProvince', 'nameClinic', 'addressClinic', 'specialtyId'];
  var isVaild = true;
  var element = '';
...
var getDetailDoctorByIdService = function getDetailDoctorByIdService(inputId) {
  return new Promise( /*#__PURE__*/function () {
...
var bulkCreateSchedules = function bulkCreateSchedules(data) {
  return new Promise( /*#__PURE__*/function () {
